"""Vance tenant resource metadata — DEPRECATED.

Source of truth has moved to chat-bot-POC's tenant-keyed JSON metadata at
`backend/data/metadata/vance/`. The legacy Python metadata is preserved as
...
# Vance is an enterprise tenant — GitOps PR flow, no Jenkins, no polling.
IS_PAAS: bool = False
